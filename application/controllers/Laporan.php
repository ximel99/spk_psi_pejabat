<?php
    ...
    class Laporan extends CI_Controller {
		...
		public function cetak_laporan_perhitungan()
		{
			...
			$this->pdf->filename = "Laporan_Perhitungan.pdf";
			$this->pdf->load_view('laporan/laporan_perhitungan', $data);
		} 
		...
		public function cetak_laporan_hasil()
		{
			...
			$this->pdf->load_view('laporan/laporan_hasil', $data);
		}
    }
